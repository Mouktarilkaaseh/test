...
<body>
    ...
    $mot=$_GET['mot'];
    $num=$_GET['nom'];
    $requet = "SELECT Nom_client FROM client where Num_tel_client=$num";
...
if (isset($_SESSION['nom'])) {
    ...
    echo"<div class='center-container'><h2 class='marquee-container'><marquee direction='up' class='marquee-text'>Liste des Films</marquee></h2></div>";
    while ($ligne = mysqli_fetch_row($resultat)) {
        echo "
        <div class='film-container' style='width:25%; height=25%'>
        <center>
<table border=0 cellspacing=0 cellpading=4><tr> <center>
<img src='image/$ligne[1]'alt='Affiche du Film' id='image' width=50% height=50%></center>
...
while($li = mysqli_fetch_row($resultatg)){
    echo "<tr><td><p>Genre:</p></td> <td>$li[1]</td></tr>";
}
echo" 
